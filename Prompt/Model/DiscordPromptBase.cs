...
namespace TomatenMusic.Prompt.Model
{
    abstract class DiscordPromptBase
    {
        ...
        protected ILogger logger = Program.Discord.Logger;
        ...
        public async Task BackAsync()
        {
            ...
            if (LastPrompt == null)
                return;
            Program.Discord.ComponentInteractionCreated -= LastPrompt.Discord_ComponentInteractionCreated;
